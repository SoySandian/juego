...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Oh Sí! Sabía que ibas a decir que sí <br> JUGUEMOS :D';
    ...
    setTimeout(function() {
        ...
        // Mostrar el div de instrucciones después del último gif
        setTimeout(function() {
